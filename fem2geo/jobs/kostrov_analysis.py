...
def run(cfg: dict, job_dir: Path) -> None:
    ...
    if show_data:
        ...
        if data_style == "contour":
            stereo_contour(ax, p_p, p_a, **data_style_cfg.contour_kwargs())
            stereo_contour(ax, b_p, b_a, **data_style_cfg.contour_kwargs())
            stereo_contour(ax, t_p, t_a, **data_style_cfg.contour_kwargs())
        else:
            stereo_line(ax, p_p, p_a, **data_style_cfg.scatter_kwargs("o"))
            stereo_line(ax, b_p, b_a, **data_style_cfg.scatter_kwargs("s"))
            stereo_line(ax, t_p, t_a, **data_style_cfg.scatter_kwargs("v"))
