...
for row in points:
    ...
    fig, ax3, D3, planes = tm.plot_summarised_tendency(avg_stress)
    ...
    ax3.legend(loc='center left', bbox_to_anchor=(0.9, 1))
    ...
    output_filename = os.path.join(output_dir, f"G_Summarised_3stereoplots_{safe_model_name}_{safe_point_label}.png")
